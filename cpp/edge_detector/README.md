...
For a more general package example, see the [waypoint_flier](https://github.com/ctu-mrs/pairs_core_examples/tree/master/cpp/waypoint_flier).
...
* Other features, which overlap with the [waypoint_flier](https://github.com/ctu-mrs/pairs_core_examples/tree/master/cpp/waypoint_flier) template
...
For a more detailed description of good programming practices in the context of ROS, see the [waypoint_flier](https://github.com/ctu-mrs/pairs_core_examples/tree/master/cpp/waypoint_flier).
